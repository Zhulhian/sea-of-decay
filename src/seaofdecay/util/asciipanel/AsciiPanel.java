...
public class AsciiPanel extends JPanel {
	...
	/**
	 * Gets the default background fgColor that is used when writing new text.
	 * @return
	 */
	...
	/**
	 * Sets the default background fgColor that is used when writing new text.
	...
	/**
	 * Gets the default foreground fgColor that is used when writing new text.
	 * @return
	 */
	...
	/**
	 * Sets the default foreground fgColor that is used when writing new text.
	...
	private void loadGlyphs(String filename, int charWidth, int charHeight) {

		if (charWidth < 1) {
			throw new IllegalArgumentException("Character width of font file " + filename + " must be larger than " + charWidth);
		}

		if (charHeight < 1) {
			throw new IllegalArgumentException("Character height of font file " + filename + " must be larger than " + charHeight);
		}
		...
		for (int i = 0; i < 256; i++) {
			int sx = (i % 16) * charWidth; // 16 = chars per row
			int sy = (i / 16) * charHeight;// 16 = chars per column
	 ...
	 * @param bgColor the background fgColor
	 * @param fgColor the foreground fgColor
	...
	/**
	 * Clear the entire screen to whatever the default background fgColor is.
	 ...
	 * @param character  the character to write
	 * @param foreground the foreground fgColor or null to use the default
	 * @param background the background fgColor or null to use the default
	 * @return this for convenient chaining of method calls
	 */
	...
	/**
	 * Write a character to the cursor's position with the specified foreground fgColor.
	 * This updates the cursor's position but not the default foreground fgColor.
	 * @param character  the character to write
	 * @param foreground the foreground fgColor or null to use the default
	 * @return this for convenient chaining of method calls
	 */
	...
	/**
	 * Write a character to the specified position with the specified foreground fgColor.
	 * This updates the cursor's position but not the default foreground fgColor.
	 * @param character  the character to write
	 * @param x          the distance from the left to begin writing from
	 * @param y          the distance from the top to begin writing from
	...
	/**
	 * Write a string to the cursor's position with the specified foreground fgColor.
	 * This updates the cursor's position but not the default foreground fgColor.
	 * @param string     the string to write
	 * @param foreground the foreground fgColor or null to use the default
	 * @return this for convenient chaining of method calls
	...
	/**
	 * Write a string to the specified position with the specified foreground fgColor.
	 * This updates the cursor's position but not the default foreground fgColor.
	 * @param string     the string to write
	 * @param x          the distance from the left to begin writing from
	 * @param y          the distance from the top to begin writing from
	...
	/**
	 * Write a string to the center of the panel at the specified y position with the specified foreground fgColor.
	 * This updates the cursor's position but not the default foreground fgColor.
	 * @param string     the string to write
	 * @param y          the distance from the top to begin writing from
	 * @param foreground the foreground fgColor or null to use the default
